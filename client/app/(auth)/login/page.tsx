  ...
  return (
    <div className="flex min-h-screen bg-[var(--base)] overflow-hidden relative">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute top-1/4 right-1/4 w-1 h-1 bg-[var(--accent)] rounded-full animate-float opacity-20 lg:hidden"></div>
        <div className="absolute bottom-1/3 left-1/3 w-1.5 h-1.5 bg-[var(--accent)] rounded-full animate-float-slow opacity-10 lg:hidden stagger-3"></div>
      </div>
        ...
        <div className="relative">
          ...
          <div className="absolute -top-32 -left-8 w-64 p-4 glass-card rounded-[var(--radius-lg)] animate-float opacity-80 shadow-2xl pointer-events-none">
            <div className="flex items-center space-x-2 mb-3">
              ...
              <div className="h-1.5 w-20 bg-[var(--border)] rounded"></div>
            </div>
            <div className="space-y-2">
              <div className="h-2 w-full bg-[var(--surface-3)] rounded"></div>
              <div className="h-2 w-3/4 bg-[var(--surface-3)] rounded"></div>
            </div>
            <div className="mt-4 flex justify-end">
              <div className="w-12 h-4 rounded-full bg-[var(--accent-dim)] border border-[var(--accent)]/20"></div>
            </div>
          </div>

          <div className="absolute -bottom-12 -right-4 w-72 p-5 glass-card rounded-[var(--radius-lg)] animate-float-slow opacity-90 shadow-2xl pointer-events-none stagger-2">
            ...
            <p className="font-sans text-[12px] text-[var(--text-secondary)] leading-relaxed">
              This note discusses the architectural migration to a micro-services pattern, identifying three key bottlenecks in the existing API...
            </p>
          </div>

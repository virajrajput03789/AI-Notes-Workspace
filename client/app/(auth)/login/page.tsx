...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen bg-[var(--base)] overflow-hidden relative">
      ...
      <div className="hidden lg:flex lg:w-[55%] relative bg-transparent p-10 flex-col justify-between z-10 h-screen overflow-hidden">
        ...
        <div className="flex-grow flex flex-col justify-center space-y-12">
          <div>
            <h2 className="font-serif text-[64px] text-[var(--text-primary)] leading-[1.05] mb-8 animate-fadeIn stagger-1">
              Where focus <br/> meets <span className="italic text-[var(--accent)]">intelligence.</span>
            </h2>
            
            <div className="grid grid-cols-2 gap-x-12 gap-y-8 animate-fadeIn stagger-2 max-w-xl">
              <div className="flex items-start space-x-3 group">
                ...
                <div>
                  ...
                  <p className="text-[12px] text-[var(--text-secondary)] leading-normal">Deep summaries generated in seconds.</p>
                </div>
              </div>
              <div className="flex items-start space-x-3 group">
                ...
                <div>
                  ...
                  <p className="text-[12px] text-[var(--text-secondary)] leading-normal">Share research with one-click links.</p>
                </div>
              </div>
              <div className="flex items-start space-x-3 group">
                ...
                <div>
                  ...
                  <p className="text-[12px] text-[var(--text-secondary)] leading-normal">Your data is encrypted and yours alone.</p>
                </div>
              </div>
              <div className="flex items-start space-x-3 group">
                ...
                <div>
                  ...
                  <p className="text-[12px] text-[var(--text-secondary)] leading-normal">Every keystroke is persisted instantly.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* BOTTOM SECTION: MOCKUP CARD */}
        <div className="mt-8 flex flex-col space-y-8">
          <div className="relative w-full max-w-[320px] p-5 glass-card rounded-[var(--radius-lg)] animate-float-slow opacity-90 shadow-2xl pointer-events-none align-self-start">
            <div className="font-serif text-[18px] text-[var(--accent)] mb-2">✦ AI Summary</div>
            <p className="font-sans text-[12px] text-[var(--text-secondary)] leading-relaxed">
              This note discusses the architectural migration to a micro-services pattern, identifying three key bottlenecks in the existing legacy API...
            </p>
          </div>
      ...
      <div className="flex-1 flex flex-col items-center p-6 md:p-12 relative z-10 overflow-y-auto lg:justify-center pt-24 lg:pt-12">
        ...
        <div className="lg:hidden w-full max-w-[420px] mb-8 animate-fadeIn">
          ...
          <h2 className="font-serif text-[40px] text-[var(--text-primary)] leading-tight mb-2">
            Intelligence for <br/> your <span className="italic text-[var(--accent)]">ideas.</span>
          </h2>
        ...
        <div className="w-full max-w-[420px] glass-card border border-[var(--border)] rounded-[var(--radius-lg)] p-8 md:p-12 shadow-[var(--shadow-lg)] animate-scaleIn stagger-1">
          ...
          <div className="mb-10 text-center lg:text-left">
            <h2 className="font-serif text-[28px] md:text-[32px] text-[var(--text-primary)] mb-2">Welcome back</h2>
            <p className="text-[var(--text-secondary)] text-[14px]">Enter your credentials to enter your workspace.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="animate-fadeIn stagger-2">
              <div className="flex items-center justify-between mb-2">
                <label className="text-[11px] font-semibold text-[var(--text-secondary)] uppercase tracking-[0.1em]">
                  Password
                </label>
                <Link href="#" className="text-[11px] text-[var(--accent)] opacity-60 hover:opacity-100 transition-opacity">Forgot?</Link>
              </div>
              <input
                type="password"
                required
          ...
          <div className="mt-10 text-center text-[13px] text-[var(--text-muted)] animate-fadeIn stagger-4">
            New to Peblo?{" "}
            <Link href="/signup" className="text-[var(--text-primary)] font-medium hover:text-[var(--accent)] transition-colors border-b border-[var(--border)] hover:border-[var(--accent)] pb-0.5">
              Create an account
            </Link>
          </div>
        </div>
